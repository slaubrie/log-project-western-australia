...
abun.emmeans.plot <- ggplot(abun.mod,aes(init, emmean, group=time))+
 ...
 # geom_line(position=position_dodge(width=0.5))+
  ...
  xlab("Treatment")+
  ylab("Abundance")+
  labs(color = "Initial Plot Treatment") +
  geom_jitter(data=dat_t0_insitu,
             aes(x=init, y=total), 
             color = "darkgrey",
             height=0,
             width=0.2,
             alpha=0.7) #+ stat_pvalue_manual(abun.mod, size = 3.5, linetype = 1, y.position = 15)
...
div.emmeans.plot <- ggplot(div.mod,aes(init, emmean, group=time))+
  ...
  geom_jitter(data=dat,
             ...
             height=0,
             width=0.25,
             alpha=0.7) #+ stat_pvalue_manual(div.mod, size = 3.5, linetype = 1, y.position = 2.8)
