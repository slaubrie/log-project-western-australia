...
##### Abundance analysis
** 2020 - 2022 **
```{r, message=FALSE, warning=FALSE, include=TRUE, paged.print=FALSE, results='markup'}
knitr::opts_chunk$set(echo = TRUE)
# packages
...
mod.dredge <- glm(total~ N+ P + K + C + CEC, data = dat_t0_insitu, family = poisson)
...
# only 2022 #
options(na.action = "na.fail")
mod.dredge.2022 <- glm(total~ N+ P + K + C + CEC, data = dat_t0_insitu,subset = (time == "t2"), family = poisson)
...
# only 2021 #
options(na.action = "na.fail")
mod.dredge.2021 <- glm(total~ N+ P + K + C + CEC, data = dat_t0_insitu, subset = (time == "t1"), family = poisson)
...
# only 2020 #
options(na.action = "na.fail")
mod.dredge.2020 <- glm(total~ N+ P + K + C + CEC, data = dat_t0_insitu, subset = (time == "t0"), family = poisson)
...
tab_model(best.2020, mod.dredge.2020, file="mod.abun_nu_2020.html", dv.labels = c("Best model", "Selected inclusive model (2020)"))
