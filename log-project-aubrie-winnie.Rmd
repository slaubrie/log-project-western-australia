...
result.df.t0 <- data.frame(
  ...
  Partitioning_of_variance = c("Call:rda(X = ass.rel.t0, Y = init, Z = block) ", "Total", "Conditioned", "Constrained", "Unconstrained"),
  Inertia = c("", 0.42624, 0.29429, 0.03551, 0.09643),
  Proportion = c("",1.00000, 0.69045, 0.08332, 0.22624),
  Note = c("Model signif. = *", "R2 = 0.08471055", "Variance explained by 'block'", "Variance explained by 'Treatment", "Unexplained variance")
  )
knitr::kable(result.df.t0, format = "html")
...
result.df.t1 <- data.frame(
  stringsAsFactors = FALSE,
  Partitioning_of_variance = c("Call:rda(X = ass.rel.t1, Y = init, Z = block) ", "Total", "Conditioned", "Constrained", "Unconstrained"),
  Inertia = c("", 0.53262, 0.28621, 0.06436, 0.18206),
  Proportion = c("",1.00000, 0.5373, 0.1208, 0.3418),
  Note = c("Model signif. = .", "R2 = 0.1186067", "Variance explained by 'block'", "Variance explained by 'Treatment", "Unexplained variance")
  )
knitr::kable(result.df.t1, format = "html")
...
result.df.t2 <- data.frame(
  stringsAsFactors = FALSE,
  Partitioning_of_variance = c("Call:rda(X = ass.rel.t2, Y = init, Z = block) ", "Total", "Conditioned", "Constrained", "Unconstrained"),
  Inertia = c("", 0.53400, 0.29726, 0.06081, 0.17593),
  Proportion = c("",1.00000, 0.5567, 0.1139, 0.3295),
  Note = c("Model signif. = .", "R2 = 0.1095098", "Variance explained by 'block'", "Variance explained by 'Treatment", "Unexplained variance")
  )
knitr::kable(result.df.t2, format = "html")
...
result.df.t012 <- data.frame(
  stringsAsFactors = FALSE,
  Partitioning_of_variance = c("Call:rda(X = ass.rel.t012, Y = init, Z = block) ", "Total", "Conditioned", "Constrained", "Unconstrained"),
  Inertia = c("", 0.56175, 0.24900, 0.03416, 0.27860),
  Proportion = c("",1.0000, 0.4433, 0.0608, 0.4959),
  Note = c("Model signif. = ***", "R2 = 0.05628909", "Variance explained by 'block'", "Variance explained by 'Treatment", "Unexplained variance")
  )
knitr::kable(result.df.t012, format = "html")
