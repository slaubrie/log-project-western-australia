...
tab_model(Hurd.mod.1.2020, Hurd.mod.2.2020, dv.labels=c("Prob. SDI>0", "Pron. when SDI>0"), title = "Shannon diversity index (SDI): 2020", file = "sdi_openlog_2020.html")
...
tab_model(Hurd.mod.1.2021, Hurd.mod.2.2021, dv.labels=c("Prob. SDI>0", "Pron. when SDI>0"), title = "Shannon diversity index (SDI): 2021", file = "sdi_openlog_2021.html")
...
tab_model(Hurd.mod.1.2022, Hurd.mod.2.2022, dv.labels=c("Prob. SDI>0", "Pron. when SDI>0"), title = "Shannon diversity index (SDI): 2022", file = "sdi_openlog_2022.html")
...
```{r, message=FALSE, warning=FALSE, include=TRUE, paged.print=FALSE, results=TRUE, fig.width=10, fig.height=12}
...
```
```{r, message=FALSE, warning=FALSE, include=TRUE, paged.print=FALSE, results=TRUE, fig.width=12, fig.height=16}
