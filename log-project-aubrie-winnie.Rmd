...
result_t012 <- data.frame(Element = character(), P_Value = numeric(), stringsAsFactors = FALSE)
...
for (element in Nu) {
  ...
  result_t012 <- rbind(result_t012, data.frame(Element = element, P_Value = p.value, stringsAsFactors = FALSE))
  rownames(result_t012) <- NULL
}

print(result_t012)

mod.t012 <- glmer(total~ NH4N + NO3N + P + K + C + pH + CEC + + (1|block) + (1|time), data = dat_t0_insitu, family = poisson)
summary(mod.t012)
...
mod.t2 <- glmer(total~ NH4N + NO3N + P + K + C + pH + CEC + + (1|block), data = dat_t0_insitu,subset = (time == "t2"), family = poisson)
summary(mod.t2)
...
mod.t1 <- glmer(total~ NH4N + NO3N + P + K + C + pH + CEC + + (1|block), data = dat_t0_insitu,subset = (time == "t1"), family = poisson)
summary(mod.t1)
...
mod.t0 <- glmer(total~ NH4N + NO3N + P + K + C + pH + CEC + + (1|block), data = dat_t0_insitu,subset = (time == "t0"), family = poisson)
summary(mod.t0)
```
...
hurd.mod.1.t012 <- glmer(non_zero~ NH4N + NO3N + P + K + C + pH + CEC + (1|block) + (1|time), data = dat, family = binomial)
summary(hurd.mod.1.t012)
# model diversity
hurd.mod.2.t012 <- lmer(diversity~ NH4N + NO3N + P + K + C + pH + CEC + (1|block) + (1|time), data = dat, subset = (non_zero == 1))
summary(hurd.mod.1.t012) 

# 2022 #
# model occurrence of zeros
hurd.mod.1.t2 <- glmer(non_zero~ NH4N + NO3N + P + K + C + pH + CEC + (1|block), data = dat,subset = (time == "t2"), family = binomial)
summary(hurd.mod.1.t2)

# model diversity
hurd.mod.2.t2 <- lmer(diversity~ NH4N + NO3N + P + K + C + pH + CEC + (1|block), data = dat, subset = (non_zero == 1 & time == "t2" ))
summary(hurd.mod.1.t2) 


# 2021 #
# model occurrence of zeros
hurd.mod.1.t1 <- glmer(non_zero~ NH4N + NO3N + P + K + C + pH + CEC + (1|block), data = dat,subset = (time == "t1"), family = binomial)
summary(hurd.mod.1.t1)

# model diversity
hurd.mod.2.t1 <- lmer(diversity~ NH4N + NO3N + P + K + C + pH + CEC + (1|block), data = dat, subset = (non_zero == 1 & time == "t1" ))
summary(hurd.mod.1.t1) 


# 2020 #
# model occurrence of zeros
hurd.mod.1.t0 <- glmer(non_zero~ NH4N + NO3N + P + K + C + pH + CEC + (1|block), data = dat,subset = (time == "t0"), family = binomial)
summary(hurd.mod.1.t0)

# model diversity
hurd.mod.2.t0 <- lmer(diversity~ NH4N + NO3N + P + K + C + pH + CEC + (1|block), data = dat, subset = (non_zero == 1 & time == "t0" ))
summary(hurd.mod.1.t0) 
```
